...
BEGIN
    ...
    THEN
		...
		CALL complete_unscheduled_chore('empty drainer', when_completed, drainer_minutes, drainer_seconds, @drainer_id, @next_drainer);
    ...
    THEN
		...
		CALL complete_unscheduled_chore('empty dishwasher', when_completed, dishwasher_minutes, dishwasher_seconds, @dishwasher_id, @next_dishwasher);
		INSERT INTO chore_completion_hierarchy
			(chore_completion_id, parent_chore_completion_id)
			VALUES
