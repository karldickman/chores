...
SELECT chore_id
        ...
        , EXP(log_normal_confidence_bound(mean_log_duration_minutes, sd_log_duration_minutes, students_t_critical_values.degrees_of_freedom, students_t_critical_values.critical_value)) AS `hypothetical 95% CI UB`
